...
const CarsList = () => {
  ...
  return (
    <div className='container'>
      <Card>
      <Button text="success" className="btn-outline-success m-1" onClick={() => navigate('/addcar')} >Ajouter une voiture</Button>
      </Card>
          ...
          <div className="inline-block min-w-full align-middle">
            <div className="overflow-hidden ">
              ...
              <tr key={car._id}>
                ...
                <td>{car.user.name}</td>
                <td>
                <Button  className='text-nowrap px-1'  onClick={() => handleDeleteCar(car._id)}   outline>
